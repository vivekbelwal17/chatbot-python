...
# Bytez API Setup (Replace with your key)
os.environ["OPENAI_API_KEY"] = "21bdab5f92c30cc178a9fc2e926f8a03"
os.environ["OPENAI_API_BASE"] = "https://api.bytez.com/v1"

# ✅ WEATHER API (Free)
WEATHER_API_KEY = "057e490a411dbc8ddd0ac3b3663b862a"  # Get free at openweathermap.org
...
def get_user_location():
    ...
    try:
        ...
        return "Delhi", "India"  # Default for India
...
class BytezChatbot:
    def __init__(self):
        ...
        self.custom_responses = {
            ...
            "who are you": "I'm your AI assistant powered by Bytez! 🤖",
            ...
            "weather": get_weather(),  # Dynamic weather
...
def main():
    ...
    if "chatbot" not in st.session_state:
        st.session_state.chatbot = BytezChatbot()
